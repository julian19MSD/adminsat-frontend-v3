...
import { formFieldsSort } from '@admin/zones/list/sort/sort.forms';
...
export class ZonesSortComponent extends CommonSort {
  ...
  constructor(
    ...
    public bottomSheetRef: MatBottomSheetRef<ZonesSortComponent>,
