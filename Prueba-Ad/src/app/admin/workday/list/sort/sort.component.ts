...
import {formFieldsSort} from '@admin/workday/list/sort/sort.forms';
import {MAT_BOTTOM_SHEET_DATA, MatBottomSheetRef} from '@angular/material/bottom-sheet';
import {FormManageService} from '@core/services/form-manage/form-manage.service';

@Component({
  selector: 'adms-workday-sort',
  templateUrl: './sort.component.html',
})
export class WorkdaySortComponent extends CommonSort {
  ...
  constructor(
    ...
    public bottomSheetRef: MatBottomSheetRef<WorkdaySortComponent>,
