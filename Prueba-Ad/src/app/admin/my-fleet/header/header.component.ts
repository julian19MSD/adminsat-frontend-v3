...
import { MyFleetHttpService } from '../services/http.service';
...
export class MyFleetHeaderComponent extends CommonHeader implements OnInit, AfterViewInit {
  ...
  constructor(
    ...
    private httpService: MyFleetHttpService,
