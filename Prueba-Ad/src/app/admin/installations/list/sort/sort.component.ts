...
import { formFieldsSort } from '@admin/installations/list/sort/sort.forms';
...
export class InstallationsSortComponent extends CommonSort {
  ...
  constructor(
    ...
    public bottomSheetRef: MatBottomSheetRef<InstallationsSortComponent>,
