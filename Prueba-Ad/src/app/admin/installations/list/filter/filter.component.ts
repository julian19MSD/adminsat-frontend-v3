...
@Component({
  selector: 'adms-installations-list-filter',
  templateUrl: './filter.component.html',
  styleUrls: ['./filter.component.scss'],
  changeDetection: ChangeDetectionStrategy.OnPush
})
export class InstallationsFilterComponent extends CommonFilter {
  ...
  constructor(
    ...
    public bottomSheetRef: MatBottomSheetRef<InstallationsFilterComponent>,
