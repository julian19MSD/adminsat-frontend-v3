...
@Component({
  selector: 'adms-notification-sort',
  templateUrl: './sort.component.html',
})
export class NotificationSortComponent extends CommonSort {
  ...
  constructor(
    ...
    public bottomSheetRef: MatBottomSheetRef<NotificationSortComponent>,
