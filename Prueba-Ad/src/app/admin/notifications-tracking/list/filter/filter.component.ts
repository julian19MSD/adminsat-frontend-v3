...
@Component({
  selector: 'adms-notification-filter',
  templateUrl: './filter.component.html',
})
export class NotificationFilterComponent extends CommonFilter {
  ...
  constructor(
    ...
    public bottomSheetRef: MatBottomSheetRef<NotificationFilterComponent>,
