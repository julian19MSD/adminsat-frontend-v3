import { NotificationHttpService } from '@admin/notifications-tracking/services/http.service';
...
import { NotificationFilterComponent } from '../filter/filter.component';
import { NotificationSortComponent } from '../sort/sort.component';
...
export class NotificationListContainer extends CommonList {
  listHeaderState = {
    title: 'TRACKING_NOTIFICATIONS',
  ...
  sortComponent = NotificationSortComponent;
  filterComponent = NotificationFilterComponent;
  ...
  constructor(
    ...
    private notificationHttp: NotificationHttpService
  ) {
    super(
      store,
      route,
