...
@Component({
  selector: 'adms-ecu-notification-sort',
  templateUrl: './sort.component.html',
})
export class ECUNotificationSortComponent extends CommonSort {
  ...
  constructor(
    ...
    public bottomSheetRef: MatBottomSheetRef<ECUNotificationSortComponent>,
