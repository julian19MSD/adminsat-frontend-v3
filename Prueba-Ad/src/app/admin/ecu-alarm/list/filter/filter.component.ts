...
import {formFieldsFilter} from '@admin/ecu-alarm/list/filter/filter.forms';
...
@Component({
  selector: 'adms-ecu-alarm-filter',
  templateUrl: './filter.component.html',
})
export class EcuAlarmFilterComponent extends CommonFilter {
  ...
  constructor(
    ...
    public bottomSheetRef: MatBottomSheetRef<EcuAlarmFilterComponent>,
