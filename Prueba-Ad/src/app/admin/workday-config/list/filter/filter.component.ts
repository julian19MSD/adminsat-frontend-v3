...
import {formFieldsFilter} from '@admin/workday-config/list/filter/filter.forms';
...
export class WorkdayConfigFilterComponent extends CommonFilter {
  ...
  constructor(
    ...
    public bottomSheetRef: MatBottomSheetRef<WorkdayConfigFilterComponent>,
